...
//         int result = consecutiveOne(nums, n);
...
// find once appering no

// public class Darray{
//     public static int singleNumbaer(int[] arr, int n){
//         int xor = 0;
//         for(int i=0; i<n; i++){
//             xor = xor ^ arr[i];
//         }
...
//         int single = singleNumbaer(arr, n);
